...
from database_setup import BaseMetal, Base, Alloy
...
#Types for Chromium
basemetal2 = BaseMetal(name = "Chromium")

session.add(basemetal2)
session.commit()

alloy2 = Alloy(name = "Nichrome", description = "Nichrome (NiCr, nickel-chrome, chrome-nickel, etc.) is any of various alloys of nickel, chromium, and often iron (and possibly other elements). The most common usage is as resistance wire, although they are also used in some dental restorations (fillings) and in a few other applications.",  basemetal = basemetal2)
...
#Types for Cobalt
basemetal3 = BaseMetal(name = "Cobalt")
...
#Types for Nickel
basemetal8 = BaseMetal(name = "Nickel")

session.add(basemetal8)
session.commit()

alloy8 = Alloy(name = "Alumel", description = "Alumel is an alloy consisting of approximately 95% nickel, 2% aluminum, 2% manganese, and 1% silicon. This magnetic alloy is used for thermocouples and thermocouple extension wire. Alumel is a registered trademark of Concept Alloys, Inc.",  basemetal = basemetal8)
